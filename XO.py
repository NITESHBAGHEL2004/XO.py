print = "made by Nitesh Singh Baghel (white devil)"
...
#print= made by Nitesh singh Baghel (whitedevil)
...
def get_text(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		...
		gb.destroy()
		box = messagebox.showinfo("made by Nitesh Singh Baghel (white devil")
...
def get_text_pc(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		...
		gb.destroy()
		x = False
		box = messagebox.showinfo("Winner", "you lose Computer won the match")
	elif(isfull()):
		gb.destroy()
		x = False
		box = messagebox.showinfo("Tie Game ", "made by Nitesh Singh Bghel")
	if(x):
		if sign % 2 != 0:
			move = pc()
